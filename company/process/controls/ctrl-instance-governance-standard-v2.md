...
*Author: WRA | Created: 2026-03-14 | Revised: 2026-03-17*
...
| Skill files, methodologies | Process knowledge (how-to guidance) | Exchange package → `company/process/mechanisms/` |
...
## 7. Instance Repo Structure (Universal Instance Skeleton v1)
...
- `company/process/` contains the instance's process definitions. Some files were seeded from C3PO enterprise governance recommendations. All are owned by the instance. Changes that affect boundary contracts (A-0 ICOM, intercompany interfaces) should be communicated via `/exchange write`.
- `company/production/[product]/specs/` contains product specification. The instance owns and evolves these freely within boundary constraints.
